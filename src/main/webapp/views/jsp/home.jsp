        ...
        <div class="row">
          ...
          <div class="col-2">
            <div class="form-container">
              ...
              <form action="/auth" id="LoginForm" method="post" name="f1">
                <input type="text" placeholder="Username" name="username" />
                <input type="password"  name="password" placeholder="Password" />
                <button type="submit" class="btn" onclick="return checkform()">Login</button>
                <a href="forgot">Forgot Password?</a>
              </form>
              <form action="/saveuser" id="RegForm" method="post" modelAttribute="user">
