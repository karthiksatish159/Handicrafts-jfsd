      ...
      <div class="container h-100">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto h-100">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="/pro">
    ...
    <div class="container mt-5">
      <div class="row tm-content-row">
        ...
        <c:set var="count" value="${count + 1}" scope="page"></c:set>
			...
			<th scope="row"><img alt="" src="${product.image}" style="width: 100px;height: 100px;"></th>
                <td>${product.decs}</td>
                <td>${product.unitinstock}</td>
                <td><a href="/delete/${product.pid}" class="btn btn-info text-right" target="_blank">delete</a></td>
            </tr>
         </c:forEach>
        </tbody>
              </table>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
            ...
            <div class="tm-product-table-container">
              <table class="table tm-table-small tm-product-table">
                <tbody>
                  ...
                  <tr>
                    <td class="tm-product-name">${cat.cname}</td>
                    <td class="text-center">
                      <a href="/deletecat/${cat.cid}" class="tm-product-delete-link">
            ...
            <a href="/addcat">Add new category</a>
            </button>
          </div>
        </div>
      </div>
