  ...
  <body>
        ...
        <div class="row">
          ...
          <div class="col-2">
            <div class="form-container">
              ...
              <form action="/authseller" id="LoginForm" method="post">
                <input type="text" placeholder="Username" name="username" required />
                <input type="password"  name="password" placeholder="Password" required />
                <button type="submit" class="btn">Login</button>
                <a href="forgot">Forgot Password?</a>
              </form>
              <form action="/saveseller" id="RegForm" method="post" modelAttribute="user">
                <input type="text" placeholder="Username"  name="username" required/>
                   ...
                   <option value="NA">North America</option>
                   	 <option value="SA">South America</option>
                   	 	...
                   	 	<option value="AU">Australia</option>	
                   	 	 <option value="AU">Antarctica</option>				
                </select>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
	    ...
	    <select  name="company" required>
				...
				<input type="text" placeholder="if selected independent please mention your companyname" name="indcom" required />
                <input type="password" placeholder="Password" name="password" />
                 <input type="password"  class="input"  name="confirm" placeholder="CONFIRM PASSWORD"/>  
                <input type="number" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" class="input"   name="mobile"  placeholder="phone number" required/>
