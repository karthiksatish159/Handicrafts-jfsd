...
%>
    ...
    <%@page import="java.util.*,java.io.*,java.sql.*,com.example.demo.Model.*,com.example.demo.Repository.*,com.example.demo.Controller.*" %>
 ...
 <input id="Plant_ID" type="hidden" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="plantId" field="{plantId}"> -->
                                ...
                                <nav>
                                    <ul id="MenuItems">
                                        ...
                                        <li><a href="/orders">Orders</a></li>
                                         <li><a href="/deliveredpro">Delivered Products</a></li>
                                        <!-- TODo: 22:20 -->
                                    </ul>
                                </nav>
          ...
          <option value="/sortcat/${cat.cid}">${cat.cname}</option>
          </c:forEach>
                                ...
                                <div class="row">
                                    ...
                                    <c:forEach var="product" items="${products}">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="rating">
                                          <%
                                          	product pp=(product)pageContext.getAttribute("product");
                                          int rate=pp.getRating();	
                                          		while(rate-->0)
                                          		{
                                          %>
